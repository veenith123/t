  ...
  async start() {
    if (gameState === 0) {
      ...
      form.display();
            ...
            cloud1 = createSprite(10,125);
            cloud1.addImage("cloud1",cloud1_img);
            cloud1.scale = 0.1;
            cloud1.visible = false;

            cloud2 = createSprite(1520,125);
            ...
            gameend.depth = board.depth+100000000000;         
            cloud1.depth =  gameend.depth+909999990000000;
            cloud2.depth =  gameend.depth+900000009999000;
